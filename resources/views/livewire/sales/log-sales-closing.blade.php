    ...
    <div class="col-lg-8 col-12 mb-4">
        <div class="card">
            <h4 class="card-header">
                <span>Daftar Customer <b class="text-success">{{ $jenisCall }} - {{ $bulanAktif }} {{ $tahunAktif }}</b></span>
                <br>
                <button type="button" class="btn btn-sm btn-primary" onclick="location.href='/sales/sales-closing/tambah'">
                        ...
                        @foreach ($pelanggan as $data)
                            <li class="timeline-item timeline-item-danger pb-3 @if ($loop->last) border-0 @else border-left-dashed @endif">
                                ...
                                <div class="timeline-event">
                                    ...
                                    <p>
                                        Unit : {{ $data->unit }} <br>
                                        Total Transaksi : {{ 'Rp '.number_format($data->harga_total,0,',','.') }}
                                    </p>
                                    <hr />
